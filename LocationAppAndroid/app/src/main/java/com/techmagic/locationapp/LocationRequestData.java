...
public enum LocationRequestData {
    ...
    FREQUENCY_MEDIUM_ONE(15 * 60 * 1000, 5 * 60 * 1000, LocationRequest.PRIORITY_HIGH_ACCURACY, 100f),
    FREQUENCY_MEDIUM_TWO(30 * 60 * 1000, 5 * 60 * 1000, LocationRequest.PRIORITY_HIGH_ACCURACY, 100f),
