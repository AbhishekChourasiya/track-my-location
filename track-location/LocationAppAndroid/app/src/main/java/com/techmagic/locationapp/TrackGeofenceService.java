...
public class TrackGeofenceService extends IntentService {

    protected static final String TAG = "TrackGeofenceService";

    public TrackGeofenceService() {
        super(TAG);
    }
    ...
    private void showNotification(String notificationDetails) {
        ...
        mNotificationManager.notify(9876, builder.build());
    }
